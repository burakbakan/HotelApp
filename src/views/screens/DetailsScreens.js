...
const DetailsScreen = ({ navigation, route }) => {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}
      ...
      <StatusBar barStyle="light-content" transculent backgroundColor="rgba(0,0,0,0)" />
        ...
        <View style={{ marginTop: 20, paddingHorizontal: 20 }}>
          ...
          <View style={{ marginTop: 10, flexDirection: 'row', justifyContent: 'space-between' }}>
            <View style={{ flexDirection: 'row' }}>
              ...
              <Text style={{ fontWeight: "bold", fontSize: 18, marginLeft: 5 }}>4.0
              </Text>
            </View>
            <Text style={{ fontSize: 13, color: COLORS.grey }}>365 Views</Text>
          </View>
      ...
      <View style={{ marginTop: 20, flexDirection: 'row', justifyContent: 'space-between', paddingLeft: 20, alignItems: 'center' }}>
        ...
        <View style={styles.priceTag}>
          <Text style={{ fontSize: 16, fontWeight: 'bold', color: COLORS.grey }}>${item.price}</Text>
          <Text style={{ fontSize: 12, fontWeight: 'bold', color: COLORS.grey }}>+breakfast</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  priceTag: {
    ...
    alignItems: 'center',
    marginLeft: 40,
    paddingLeft: 20, backgroundColor: COLORS.secondary,
